...
class Agent extends AbstractEntity
{
    ...
    #[Groups(['agent.get', 'event.get', 'initiative.get', 'opportunity.get', 'space.get', 'user.get', 'organization.get', 'phase.get', 'inscription-opportunity.get', 'inscription-phase.get'])]
