...
final class Version20241122191255 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE address (id UUID NOT NULL, city_id UUID NOT NULL, street VARCHAR(100) NOT NULL, number VARCHAR(5) NOT NULL, neighborhood VARCHAR(50) NOT NULL, complement VARCHAR(100) NOT NULL, zipcode VARCHAR(8) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, deleted_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, owner_type VARCHAR(255) NOT NULL, owner_id UUID NOT NULL, PRIMARY KEY(id))');
