...
final class Version20250120220338 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_41B01415309C6E2D ON inscription_phase_review (inscription_phase_id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_41B0141570574616 ON inscription_phase_review (reviewer_id)');
